...
const handleSave = async () => {
  ...
  if (edithProduct.newImageFile) formData.append('image', edithProduct.newImageFile);
   setIsLoading(true)
  try{
  let res = await axios.put(`http://localhost:5000/api/products/${edithProduct._id}`, formData, {
  ...
  return (
    <>
         ...
         {notifKey > 0 && (
            ...
            >
              {isSuccessful ? "Product Updated Successfully" : "Update Product Failed"}
            </GluxNotification>
          )}
          ...
          <BackgroundCover className={`${openEdithProdut ? "hide" : "show"}`}>
            <form className={`edith-form ${openEdithProdut?'hide':'show'} `}>
              ...
              <div className="edith-form-input-container">
                <div className="edith-product-image-container">
                  ...
                  <figure>
                    <img src={edithProduct.image} alt={edithProduct.name} />
                     <button
                     onClick={() => document.getElementById('edith-product-image').click()}
                     type="button" className="edith-product-photo-btn bg-text-muted" disabled={true}>
                       edith photo
                     </button>
                  </figure>
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={e => setEdithProduct({ ...edithProduct, name: e.target.value })}
                     />
                </div>
                ...
                <div className="grid-input-container">
                  <div>
                    ...
                    <input 
                      ...
                      onChange={e => setEdithProduct({ ...edithProduct, price: e.target.value })}
                       />
                  </div>
                  <div>
                    ...
                    <input 
                      ...
                      onChange={e => setEdithProduct({ ...edithProduct, stockquantity: e.target.value })}
                       />
                  </div>
                  <div className="d-flex  flex-column ">
                    ...
                    onChange={e => setEdithProduct({ ...edithProduct, category: e.target.value })}
                    >
                  ...
                  <div className={`${edithProduct.category == 'shoe' ? 'd-none': ''}`}>
                    <label htmlFor="edith-product-width">Width:</label>
                    <input 
                      type="number" 
                      id="edith-product-width" 
                      value= {edithProduct?.width || 0}
                      onChange={e => setEdithProduct({ ...edithProduct, width: e.target.value })}
                      />
                  </div>
                  <div className={`${edithProduct.category == 'shoe' ? 'd-none': ''}`}>
                    ...
                    <input 
                      ...
                      onChange={e => setEdithProduct({ ...edithProduct, height: e.target.value })}
                      />
                  </div>
                  ...
                  <div className={`${edithProduct.category == 'shoe' ? '': 'd-none'}`}>
                    ...
                    <select
                      ...
                      onChange={e => setEdithProduct({ ...edithProduct, size: e.target.value })}
                    >
              ...
              <button 
               ...
               disabled={isLoading}
               >
                 {isLoading? <LoaderCircle className={`spin text-white `}/>  : <Save />}
                Save Changes
              </button>
              </div>
            </form>
